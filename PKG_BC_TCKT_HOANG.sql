...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Package Body PKG_BC_TCKT_HOANG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "KTNB_TEST"."PKG_BC_TCKT_HOANG" AS  
   /*
    ...
    BEGIN
        ...
        INSERT INTO tbr_tc_bc_001 (
            ...
            WHERE
                ...
                AND ht.ma_tk = nvl(p_ma_tk, '00')
                AND ht.dc_sddn = 'X'
                AND trunc(ht.ngay_ht, 'DD') BETWEEN nvl(p_ngay_tu, TO_DATE('01/01/1900', 'DD/MM/YYYY')) AND nvl(p_ngay_den, TO_DATE(
                '02/01/1900', 'DD/MM/YYYY'))
           GROUP BY
                ht.ma_tk;        
        ...
        INSERT INTO tbr_tc_bc_001 (
            ...
            WHERE
                    ht.ma_dvhq = nvl(p_ma_dvhq, '00')
                AND ht.ma_tk = nvl(p_ma_tk, '00')
                AND trunc(ht.ngay_ht, 'DD') BETWEEN trunc(nvl(p_ngay_tu, TO_DATE('01/01/1900', 'DD/MM/YYYY')), 'YEAR') AND nvl(p_ngay_den,
                    ...
                    FROM
                        (
                            ...
                            WHERE
                                ...
                                AND trunc(ht.ngay_ht, 'DD') < add_months(trunc(nvl(p_nam, TO_DATE('1900', 'YYYY')), 'YEAR'), 0)
                            GROUP BY
                                dmtk.id,
                                ht.ma_tk,
                                dmtk.ten,
                    ...
                    FROM
                        (
                            ...
                            WHERE
                                ...
                                AND substr(ht.ma_tk, 1, 3) NOT IN ( '131', '331','138','338')
                                AND ht.ma_tk = dmtk.ma
                                AND trunc(ht.ngay_ht, 'DD') <= add_months(trunc(nvl(p_nam, TO_DATE('1900', 'YYYY')), 'YEAR') - 1,
                                12)
                            GROUP BY
                                dmtk.id,
                                ht.ma_tk,
                            ...
                            FROM
                                (
                                    ...
                                    WHERE
                                        ...
                                        AND trunc(ht.ngay_ht, 'DD') < add_months(trunc(nvl(p_nam, TO_DATE('1900', 'YYYY')), 'YEAR'),
                                        0)
                                    GROUP BY
                                        ht.ma_tk,
                                        ht.dttk
            ...
            FROM
                (
                    ...
                    WHERE
                        ...
                        AND ht.ma_loai_nv IN ( '09', '10', '11', '12', '13',
                                               '14', '17', '18', '19', '20' )
                        AND trunc(ht.ngay_ht, 'DD') BETWEEN add_months(trunc(nvl(p_nam, TO_DATE('1900', 'YYYY')), 'YEAR'), - 12) AND
                    ...
                    FROM
                        (
                            ...
                            WHERE
                                ...
                                AND tttuct.ngay_ht BETWEEN trunc(nvl(p_nam, TO_DATE('1900', 'YYYY')), 'YEAR') AND add_months(trunc(
                                nvl(p_nam, TO_DATE('1900', 'YYYY')), 'YEAR') - 1, 12)
                            GROUP BY
                                tttuct.ma_nguon_ns,
                                tttuct.khoan
